  ...
  return (
    <div className="relative flex flex-col items-center justify-center min-h-screen px-6 py-10">
      ...
      <div className="my-5 flex items-center gap-3 w-full">
        ...
        <span className="text-brand-400 text-sm font-medium">o continuar con</span>
        <div className="flex-1 h-px bg-brand-200"/>
      </div>
      ...
      <div className="flex gap-3 w-full">
        <button
          ...
          className="flex-1 flex items-center justify-center gap-2 bg-white rounded-2xl py-3.5
                     shadow-card border border-gray-100 font-semibold text-gray-700
      ...
      <div className="mt-6 flex flex-col items-center gap-2">
        <Link href="/register" className="text-brand-600 font-bold text-sm">
          No tienes cuenta? <span className="underline">Regístrate</span>
        </Link>
        <Link href="/forgot-password" className="text-brand-400 text-sm">
          — Forgot Password? —
        </Link>
      </div>
    </div>
